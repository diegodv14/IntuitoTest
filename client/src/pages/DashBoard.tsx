...
export const Dashboard = () => {
    ...
    return (
        <main className="flex flex-row h-screen">
            <section className="w-[60%] h-full flex flex-col p-8">
                ...
                <ul className="w-[full] flex-1 h-[85%] billboards mt-6 p-2">
                    {BillBoards.map(BillBoard => <li onMouseOver={() => setMovie(BillBoard.Movie.name)} className="size-36 relative w-full h-[200px] rounded-lg flex flex-col justify-between">
                        <div className="bg-red-500 rounded-md w-full h-[80%] shadow-md imageMovie">
                        </div>
                        <div className="h-[20%] p-4 flex items-center justify-between flex-row">
                            <h1 className="whitespace-nowrap">{BillBoard.Movie.name}</h1>
                            <p className="flex flex-row gap-2 items-center"><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-stopwatch" viewBox="0 0 16 16">
            ...
            <aside className="flex-1 p-10 flex items-center justify-center movie relative">
                <div className="flex flex-row gap-6 ml-3 h-fit absolute top-12 right-6 text-white">
                    <Link to={'/Butaca'} className="text-sm" title="Administrar Butacas"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-inboxes-fill" viewBox="0 0 16 16">
                    ...
                    <Link to={'/Cartelera'} className="text-sm" title="Administrar Cartelera"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-film" viewBox="0 0 16 16">
                        <path d="M0 1a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1zm4 0v6h8V1zm8 8H4v6h8zM1 1v2h2V1zm2 3H1v2h2zM1 7v2h2V7zm2 3H1v2h2zm-2 3v2h2v-2zM15 1h-2v2h2zm-2 3v2h2V4zm2 3h-2v2h2zm-2 3v2h2v-2zm2 3h-2v2h2z" />
                    </svg></Link>
                </div>
                <FormReserva movie={movie} />
            </aside>
        </main>
    )
}