        ...
        <section className="w-screen h-screen">
            <div className="flex flex-col gap-2">
                <div className="font-[Tanker] text-2xl shadow-lg w-full flex items-center justify-between p-4"><span>Este es el listado de peliculas que puedes ver segun tu edad 🔞</span>
                    <button onClick={() => setEmptyCustomer()} title="Volver al Registro"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
                ...
                {billBoardByAge.length > 0 && <ul className="w-[full] p-6 pt-4 h-[230px] items-center billboards gap-6">
                    {billBoardByAge.map(BillBoard => <li key={BillBoard.id} onMouseOver={() => setMovie(BillBoard.Movie.name)} className="relative w-[300px] h-[200px] rounded-lg flex flex-col justify-between">
